...
public class RegistrarEmpleado extends JDialog {
	...
	public RegistrarEmpleado(Empleado empleado){
		...
		panelReg.setLayout(null);
		{
			...
			lblIdEmpleado = new JLabel("EMP-" + Altice.idEmpleado);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnRegistrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(emp == null) {
							Empleado aux = new Empleado(txtNombre.getText(), crearUsuario(), new Integer(spnEdad.getValue().toString()),txtDireccion.getText(),getSexo(), txtTelefono.getText(), txtCorreo.getText(), txtRNC.getText(),lblIdEmpleado.getText());
						...
						/*else {
							...
							emp.setEdad(new Integer(spnEdad.getValue().toString()));
							emp.setSexo(getSexo());
							emp.setNumeroContacto(getName());
							emp.setDireccion(getName());
							...
							ListarEmpleados.loadEmpleados();
							ListarEmpleados.btnDespedir.setEnabled(false);
							ListarEmpleados.btnModificar.setEnabled(false);
							dispose();
						}*/
	...
	public void clean() {
		lblIdEmpleado.setText("EMP-" + Altice.idEmpleado);
		txtNombre.setText("");
		txtRNC.setText("");
