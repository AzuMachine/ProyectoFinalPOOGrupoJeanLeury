...
public class RegistrarServicio extends JDialog {
    ...
    private void initComponents() {
        ...
        panelCampos.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
        ...
        panelPrecio.setBorder(new SoftBevelBorder(BevelBorder.RAISED));
    ...
    private void createButtonPane() {
        ...
        btnRegServ.addActionListener(e -> ejecutarRegistro());
    ...
    private void ejecutarRegistro() {
        if (cbxFiltroServ.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar un tipo de servicio.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }

        if (txtNombreServ.getText().trim().isEmpty() || txtPrecio_Serv.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Nombre y Precio son obligatorios.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (seleccion.contains("INTERNET")) servEnum = Serv.INTERNET;
            else if (seleccion.contains("TELEVISIÓN")) servEnum = Serv.TELEVISION;
            else if (seleccion.contains("TELEFONÍA")) servEnum = Serv.TELEFONIA;
            ...
            JOptionPane.showMessageDialog(null, "Precio inválido. Use números.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void clean() {
        ...
        cbxFiltroServ.setSelectedIndex(0);
    ...
    private void actualizarSegunSeleccion() {
        ...
        switch (index) {
            case 1: txtID_Serv.setText("ALT-FIB-" + Altice.getInstance().getIdServFIB()); break;
            case 2: txtID_Serv.setText("ALT-TV-" + Altice.getInstance().getIdServTV()); break;
            case 3: txtID_Serv.setText("ALT-TEL-" + Altice.getInstance().getIdServTEL()); break;
            default: txtID_Serv.setText(""); break;
        }
    }
}