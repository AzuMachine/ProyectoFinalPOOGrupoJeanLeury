...
public class ListarParaAsignarPlanes extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ListarParaAsignarPlanes dialog = new ListarParaAsignarPlanes();
	 ...
	 * Create the dialog.
	 */
	public ListarParaAsignarPlanes() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ListarParaAsignarPlanes.class.getResource("/Imagenes/AlticeLogoVentanas.PNG")));
		setResizable(false);
		setTitle("Asignar planes: listado de planes existentes");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnCancelar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						ListarParaAsignarPlanes.selected = null;
						dispose();
					}
				});
				{
